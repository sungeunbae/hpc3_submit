...
## END HEADER
export gmsim="/home/arr65/src"
echo "gmsim environment variable set to: $gmsim"
...
cd $FAULT_DIR
echo "Running fix_old_nesi_path.sh..."
/scratch/jobs/arr65/mike/fix_old_nesi_path.sh
echo "fix_old_nesi_path.sh completed, changing back to REL_DIR: $REL_DIR"
cd -
...
# srun python $gmsim/workflow/workflow/calculation/bb_sim.py $REL_DIR/LF/OutBin $BASE_DIR/Data/VMs/$JOBNAME $REL_DIR/HF/Acc/HF.bin /nesi/project/nesi00213/StationInfo/geoNet_stats+2023-06-28.vs30 $REL_DIR/BB/Acc/BB.bin --flo 1.0 --fmin 0.2 --fmidbot 0.5 --dt 0.005
 srun python $gmsim/workflow/workflow/calculation/bb_sim.py $REL_DIR/LF/OutBin $BASE_DIR/Data/VMs/$JOBNAME $REL_DIR/HF/Acc/HF.bin /scratch/jobs/arr65/StationInfo/geoNet_stats+2023-06-28.vs30 $REL_DIR/BB/Acc/BB.bin --flo 1.0 --fmin 0.2 --fmidbot 0.5 --dt 0.005
